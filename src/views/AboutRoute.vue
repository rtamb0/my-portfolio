<template>
  <div class="flex flex-col p-10 items-center">
    ...
    <div class="flex relative h-10">
      <!-- Left edge -->
      <div
        class="relative border-r-20 border-t-20 border-t-transparent border-b-20 border-b-transparent border-r-[#4a67d6]"
      ></div>
      <!-- Job-title body -->
      <div class="flex h-10 px-10 items-center overflow-hidden bg-[#4a67d6]">
        <h3 class="font-semibold italic text-white text-xl">Background</h3>
      </div>
      <!-- Right edge -->
      <div
        class="relative border-l-20 border-t-20 border-t-transparent border-b-20 border-b-transparent border-l-[#4a67d6]"
      ></div>
    </div>
